...
export class SkillExecutorService {
  ...
  async *executeStream(
    ...
    yield {
      type: 'thinking',
      content: `可用工具: ${toolDefs.map((t) => t.name).join(', ') || '无'}`,
    };
  ...
  private buildToolDefinitions(capabilities: string[]): ToolDefinition[] {
      ...
      refactor: {
        ...
        parameters: {
          ...
          properties: {
            ...
            goal: {
              type: 'string',
              description: '重构目标: performance|readability|modularity',
            },
          },
          required: ['code'],
        },
      ...
      doc: {
        ...
        parameters: {
          ...
          properties: {
            ...
            format: {
              type: 'string',
              description: '文档格式: markdown|jsdoc|openapi',
            },
          },
          required: ['code'],
        },
      ...
      test: {
        ...
        parameters: {
          ...
          properties: {
            ...
            framework: {
              type: 'string',
              description: '测试框架: jest|vitest|pytest',
            },
          },
          required: ['code'],
        },
      ...
      deploy: {
        ...
        parameters: {
          ...
          properties: {
            platform: {
              type: 'string',
              description: '部署平台: vercel|ecs|k8s',
            },
    ...
    return capabilities.filter((c) => registry[c]).map((c) => registry[c]);
  }
...
请用中文回答，代码用对应语言的语法高亮标记。`;
  ...
  private parseToolCalls(
    ...
    return tools.filter((t) =>
      output.toLowerCase().includes(t.name.toLowerCase()),
    );
  }
}
